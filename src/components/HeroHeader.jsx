...
export default function HeroHeader () {
    ...
    return (
        ...
        md:grid-rows-tabletHeaderLayout 
         overflow-hidden" id="home" role={'navigation'}>    
       ...
       >
                <div className="absolute md:-right-[5.75rem] xl:-right-[10.25rem] bottom-0 right-0">
                    ...
                    onClick={()=> changeSlider.toLeft(indexSlider)} id='button-left' title="left">
                    ...
                    onClick={()=> changeSlider.toRight(indexSlider)} id='button-right' title="right">

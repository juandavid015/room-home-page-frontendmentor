export const headerContent = [
    { 
        desktopImage: 'mobile:bg-desktop-hero-1',
        mobileImage: 'bg-mobile-hero-1',
    ...
    {
        desktopImage: 'mobile:bg-desktop-hero-2',
        mobileImage: 'bg-mobile-hero-2',
    ...
    {
        desktopImage: 'mobile:bg-desktop-hero-3',
        mobileImage: 'bg-mobile-hero-3',
